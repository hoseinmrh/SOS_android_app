                        ...
                        public void onSuccess(Location location) {
                            ...
                            if (location != null) {
                                ...
                                for (ContactModel c : list) {
                                    String message = "Hey, " + c.getName() + " I have fallen, i need help. Please reach me out. Here are my coordinates.\n " + "http://maps.google.com/?q=" + location.getLatitude() + "," + location.getLongitude();
                                    smsManager.sendTextMessage(c.getPhoneNo(), null, message, null, null);
                                }
                            } else {
                                String message = "I have fallen, i need help. Please  reach me out.\n" + "GPS was turned off.Couldn't find location. Call your nearest SOS.";
                                SmsManager smsManager = SmsManager.getDefault();
                                DbHelper db = new DbHelper(SensorService.this);
                                List<ContactModel> list = db.getAllContacts();
                                for (ContactModel c : list) {
